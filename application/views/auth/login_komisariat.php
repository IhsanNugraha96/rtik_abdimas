          ...
          <div class="col-lg-5" data-aos="fade-up">
            <div class="p-5">
              <div class="text-center">
                <h1 class="h4 text-gray-900 mb-4">Halaman Masuk <br>(Komisariat)</h1><br>
              </div>
               <!-- notifikasi -->
              ...
              <form class="user was-validated" method="post" action="<?= base_url('Auth');  ?>">
              	<div class="form-group">
				    <input type="username" class="form-control is_invalid form-control-user" id="username" name="username" placeholder="id komisariat/username/e-mail" required>
				    <div class="invalid-feedback">
				      Harap mengisi id komisariat/username/email.
				    </div>
				</div>
                <div class="form-group">
