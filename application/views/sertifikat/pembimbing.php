...
<html><head>
	...
	<title> RTIKAbdimas - Piagam Penghargaan Pembimbing</title>
	...
	<div  style="z-index: 2; position: absolute; margin-top: -110%;" >
		<table  style="margin-top: 2%;">
			...
			<tr class="text-center">
				<td>
					<h1 style="font-size: 5vw; margin-top: 3%;" class="font-weight-bold text-black"><?= $pembimbing['nama']; ?></h1>
				</td>
			</tr>
			<tr class="text-center">
				<td style="padding: 0 5% 0 5%;">
					<h5 style="font-size: 3vw;">Atas partisipasinya sebagai pembimbing <br>dalam mengikuti program <b>Relawan TIK Abdi Masyarakat Tahun <?= substr($event['date_created'], 0, 4); ?></b>, dengan jumlah tim yang di bimbing berjumlah <b><?= $tim_bimbingan; ?> tim</b>.</h5>
				</td>
			</tr>
		</table>
