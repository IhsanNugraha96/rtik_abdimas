...
<html><head>
	...
	<title> RTIKAbdimas - Piagam Penghargaan Instruktur</title>
	...
	<div  style="z-index: 2; position: absolute; margin-top: -110%;" >
		<table  style="margin-top: 2%;">
			...
			<tr class="text-center" height="6%">
				<td>
					<h1 style="font-size: 6vw; margin-top: 5%;" class="font-weight-bold text-black">PIAGAM PENGHARGAAN</h1>
				</td>
			</tr>
			...
			<tr class="text-center">
				<td>
					<h1 style="font-size: 5vw; margin-top: 3%;" class="font-weight-bold text-black"><?= $instruktur['nama']; ?></h1>
				</td>
			</tr>
			<tr class="text-center">
				<td style="padding: 0 5% 0 5%;">
					<h5 style="font-size: 3vw;">Atas partisipasinya sebagai instruktur acara pembekalan <br>dalam program <b>Relawan TIK Abdi Mayarakat Tahun <?= substr($pembekalan['date_created'], 0, 4); ?></b></h5>
				</td>
			</tr>
		</table>
