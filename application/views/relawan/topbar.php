      ...
      <div id="content">
        ...
        <nav class="navbar navbar-expand navbar-light bg-white topbar static-top shadow">
          ...
          <div class="d-none d-sm-inline-block form-inline mr-auto ml-md-3 my-2 my-md-0 mw-100 navbar-search">
            <div>
              <img src="<?= base_url('assets/img/komisariat/').$komisariat['logo']; ?>" style="width: 11%;" alt="Logo Pangkalan">
            </div>
          </div>
          ...
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item dropdown no-arrow">
              <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                <span class="mr-2 d-none d-lg-inline text-gray-600 small"><?= $relawan['nama_lengkap'] ?></span>
               <img class="img-profile rounded-circle" src="<?= base_url('assets/img/relawan/image/'.$relawan['image']) ?>">
              </a>
              <!-- Dropdown - User Information -->
              <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="userDropdown">
                <a class="dropdown-item" href="<?= base_url('relawan/profil') ?>">
                  <i class="fas fa-user fa-sm fa-fw mr-2 text-gray-400"></i>
                  Profil
                </a>
                <a class="dropdown-item" href="<?= base_url('relawan/edit_profil') ?>">
