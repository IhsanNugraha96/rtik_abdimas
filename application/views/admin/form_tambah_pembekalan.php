...
<div class="container-fluid">
	...
	<!-- Page Heading -->
	<h1 class="h3 mb-4 text-gray-800">Formulir tambah acara pembekalan</h1>
			...
			<form class="user was-validated" method="post" action="<?= base_url('Admin/ubah_event/tambah_acara_pembekalan/'.urlencode($event['id_event']));?>" enctype="multipart/form-data">
				<div class="form-group">
					<select class="custom-select"  name="pilihan_instruktur"  id="pilihan_instruktur" required oninvalid="this.setCustomValidity('Anda belum memilih instruktur..')" oninput="setCustomValidity('')">
						...
						<option value="<?= $ist['id_instruktur']; ?>"><?= $i.'. '.$ist['nama']; ?></option>
						<?php $i++; endforeach ?>                    
					</select>
				...
				<!-- <div class="form-group">
					<input type="text" class="form-control"  name="materi"  id="materi" placeholder="nama materi pembekalan" aria-describedby="inputGroupPrepend" required oninvalid="this.setCustomValidity('Anda belum mengisi judul materi pembekalan..')" oninput="setCustomValidity('')">

					<?= form_error('pendidikan', '<small class="text-danger pl-3">','</small>'); ?>
					<div class="invalid-feedback">Isi nama materi pembekalan.</div>                
					<div class="valid-feedback text-left">Materi pembekalan.</div>
				</div> -->

				<div class="form-group">
					<input type="text" class="form-control" id="link_materi" name="link_materi" placeholder="Link berkas materi pembekalan" aria-describedby="inputGroupPrepend" required oninvalid="this.setCustomValidity('Anda belum mengisi link berkas materi pembekalan')" oninput="setCustomValidity('')">
				...
				<div class="form-group">
					<input type="text" class="form-control" id="link_meeting" name="link_meeting" placeholder="Link acara pembekalan" aria-describedby="inputGroupPrepend" required oninvalid="this.setCustomValidity('Anda belum mengisi link acara pembekalan')" oninput="setCustomValidity('')">
				...
				<div class="form-group">
					<input type="date" class="form-control" id="date" name="tgl" placeholder="Tanggal acara pembekalan" aria-describedby="inputGroupPrepend" required oninvalid="this.setCustomValidity('Anda belum menentukan tanggal <?= $Judul[$i]; ?>')" oninput="setCustomValidity('')">
				...
				<div class="form-group">
					<input type="time" class="form-control" id="time" name="time"  min="00:00" max="23:59" required oninvalid="this.setCustomValidity('Harap tentukan waktu acara pembekalan')" oninput="setCustomValidity('')">
				...
				<div class="form-group">
					<textarea class="form-control" id="pengumuman" name="pengumuman" placeholder="buat pengumuman tentang acara pembekalan ini" oninvalid="this.setCustomValidity('Anda belum mengisi pengumuman acara pembekalan')" oninput="setCustomValidity('')" required></textarea>
