      ...
      <div id="content">
        ...
        <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
          ...
          <div class="d-none d-sm-inline-block form-inline mr-auto ml-md-3 my-2 my-md-0 mw-100 navbar-search">
            <div>
              <img src="<?= base_url('assets/img/logo/Kemkominfo.png'); ?>" style="width: 12%;" alt="Logo Kemkominfo">
              <img src="<?= base_url('assets/img/logo/logo rtik.png'); ?>" style="width: 10%;" alt="Logo admin RTIK">
            </div>
          </div>
          ...
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item dropdown no-arrow">
              <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
               ...
               <img class="img-profile rounded-circle" src="<?= base_url('assets/img/admin/'.$admin['image']) ?>">
